<template>
    <DefaultField
        ...
        :class="field?.repeaterWrapperClass ?? 'custom-repeater-wrapper'"
    >
        <template #field>
            <div v-if="value.length > 0" class="space-y-4" :dusk="fieldAttribute">
                <RepeaterRow
                    ...
                    :class="field.repeaterItemClass ?? 'custom-repeater-item'"
                />
            </div>
            <div>
                <div
                    class="text-center custom-repeater-action-wrapper"
                    :class="{
                ...
                >
                    <Dropdown v-if="currentField.repeatables.length > 1">
                        <Button
                            ...
                            class="custom-repeater-add-button"
                        >
                            {{ __('Add item') }}
                        </Button>
                    ...
                    <InvertedButton
                        ...
                        type="button"
                        :class="field.addButtonClass ?? 'custom-repeater-add-button'"
                    >
            <span>{{
                    __('Add :resource', {
