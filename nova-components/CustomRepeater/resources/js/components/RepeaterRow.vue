<template>
    ...
    >
        <div
            class="flex items-center bg-gray-50 dark:bg-gray-800 py-2 px-3 rounded-t custom-repeater-item-actions-wrapper"
        >
            <div class="flex items-center space-x-2">
                <IconButton
                    ...
                    solid
                    small
                    class="custom-repeater-item-actions-wrapper__icon"
                />
                <IconButton
                    v-if="sortable"
            ...
            <IconButton
                ...
                class="ml-auto custom-repeater-item-actions-wrapper__remove-icon"
                iconType="trash"
                solid
                small
            />
        ...
        <div
            ...
            :class="field.fieldClass ?? 'custom-repeater-item-fields-wrapper'"
        >
            <div v-for="(fld, fieldIndex) in item.fields">
                <component
                    :ref="fieldRefs[`fields.${fld.attribute}`]"
                    :is="'form-' + fld.component"
                    :field="fld"
                    :index="fieldIndex"
                    :errors="errors"
                    :show-help-text="true"
                    ...
                    :class="field.fieldComponentClass || 'custom-repeater-item-fields-wrapper__field'"
                />
